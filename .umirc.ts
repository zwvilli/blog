...
export default defineConfig({
  ...
  routes: [
    ...
    {
      path: '/admin/posts', name: '文章管理', icon: 'icon-wenzhang',
      routes: [
    ...
    {
      path: '/admin/user', name: '用户管理', icon: 'icon-wode1',
      routes: [
    ...
    {
      path: '/admin/category', name: '分类管理', icon: 'icon-xiangmuguanli', routes: [
    ...
    {
      path: '/admin/banner', name: '轮播管理', icon: 'icon-tuwen', routes: [
